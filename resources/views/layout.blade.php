        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="dashboard-mahasiswa.html" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="profile.html" class="d-block">PT. Techno Sejahtera</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="dashboard-mitra-lowongan.html" class="nav-link ">
                                        <i class="far fa-copy nav-icon"></i>
                                        <p>Lowongan</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="dashboard-mitra-pendaftar.html" class="nav-link">
                                        <i class="far fa-copy nav-icon"></i>
                                        <p>Pendaftar</p>
                                    </a>
                                </li>
